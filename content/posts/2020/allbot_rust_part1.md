...
That is it for part 1! In the [next part]({{< relref "/posts/2020/allbot_rust_part2" >}}), we will write Rust to control a servo motor with Pulse-Width Modulation peripheral by accessing hardware at the PAC level.